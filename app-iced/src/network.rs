...
async fn serve_demo(
    ...
    let chats = vec![
        DemoChat { id: 1001, title: "Camille", subtitle: "Great! see you tomorrow 👋", last_ago: 42, unread: 3, hue: 0.55 },
        DemoChat { id: 1002, title: "Rust Group", subtitle: "Thomas: novel review of the PR?", last_ago: 7200, unread: 0, hue: 0.1 },
        DemoChat { id: 1003, title: "Landscape Channel", subtitle: "Sunset over the sea 🏖", last_ago: 86400, unread: 0, hue: 0.95 },
        DemoChat { id: 1004, title: "Family Group", subtitle: "Mom: when are you coming over?", last_ago: 172800, unread: 12, hue: 0.3 },
